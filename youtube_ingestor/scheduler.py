...
Uso:
  python -m youtube_ingestor.scheduler            # roda perene (Ctrl+C para sair)
  python -m youtube_ingestor.scheduler --once     # roda 1 ciclo de cada canal e sai
  python -m youtube_ingestor.scheduler --status   # imprime resumo do estado

Para rodar como servico na VPS, ver scripts/ingestor.service (systemd).
"""
